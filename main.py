...
async def sydney_process_message(user_message, context, _U, locale, imageInput):
    ...
    try:
        ...
        #else:
        cookies = [{"name": "_U", "value": "qeretttskjllgjgznWRddcDFKFKFF"},{"name": "SRCHHPGUSR","value": "cdxtone=Creative&cdxtoneopts=h3imaginative,gencontentv3&BRW=XW&BRH=M&CW=1496&CH=796&SCW=1204&SCH=316&DPR=2.3&UTC=480&DM=0&PRVCW=1496&PRVCH=796"}]
